package no.nav.hackathon.secretary.slack;

import no.nav.hackathon.secretary.jbot.common.Controller;
import no.nav.hackathon.secretary.jbot.common.EventType;
import no.nav.hackathon.secretary.jbot.common.JBot;
import no.nav.hackathon.secretary.jbot.slack.Bot;
...
public class SlackBot extends Bot {
    ...
    static {
        slackToken = System.getenv("BOT_TOKEN");
    }
